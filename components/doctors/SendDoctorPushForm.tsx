    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {loadingStatus ? (
        <p className="flex items-center gap-2 text-sm text-gray-500">
          ...
          Loading FCM token from doctor profile…
        </p>
      ) : null}
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <label htmlFor="doctor-push-title" className="text-xs font-medium text-gray-600">
            Title
          </label>
          <Input
            id="doctor-push-title"
            value={title}
        ...
        <div className="space-y-1.5">
          <label htmlFor="doctor-push-route" className="text-xs font-medium text-gray-600">
        ...
        <div className="space-y-1.5 sm:col-span-2">
          <label htmlFor="doctor-push-body" className="text-xs font-medium text-gray-600">
            Message
          </label>
          <Textarea
            id="doctor-push-body"
            ...
            placeholder="You have a new appointment request."
            rows={3}
            maxLength={500}
            disabled={disabled}
            required
